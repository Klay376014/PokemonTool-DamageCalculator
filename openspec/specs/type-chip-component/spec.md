# Spec: TypeChip Component

## Overview

A reusable `TypeChip` Vue component that renders a visually styled chip for a Pokémon type, used across multiple views to display type badges with consistent colors and localized labels.
...
<!-- @trace
source: extract-type-chip-component
updated: 2026-04-19
code:
  - app/utils/typeColors.ts
  - app/components/TypeChip.vue
  - app/components/PokemonInfo.vue
  - app/components/SelectSheet.vue
tests:
  - tests/components/TypeChip.test.ts
-->
