# apple-visual-theme Specification

## Purpose

TBD - created by archiving change 'apple-style-redesign'. Update Purpose after archive.
...
code:
  ...
  - DESIGN.md
  - new_forms.yaml
  - docs/superpowers/specs/2026-04-12-apple-style-redesign.md
  - nuxt.config.ts
-->
