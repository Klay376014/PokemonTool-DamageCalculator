...
async function getPokemon() {
  ...
  if (targetPokemon1) {
    ...
    // 拿圖片網址
    pm1.imgUrl = random > 1 ? targetPokemon1.sprite.front_default : targetPokemon1.sprite.front_shiny
    // 拿種族值
  ...
  if (targetPokemon2) {
    ...
    // 拿圖片網址
    pm2.imgUrl = random > 1 ? targetPokemon2.sprite.front_default : targetPokemon2.sprite.front_shiny
    // 拿種族值
